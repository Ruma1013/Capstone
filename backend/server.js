      ...
      if (passwordMatch) {
        ...
        res.status(200).json({
          ...
          userDetails: {
            ...
            LC: licenseNumber,
            url: youtubeUser.url,
            image: youtubeUser.image, // URL from YouTubeUser
          }
        });
      } else {
...
app.put('/api/usersdetails/:licenseNumber', async (req, res) => {
...
app.delete('/api/usersdetails/:licenseNumber', async (req, res) => {
  const { licenseNumber } = req.params;
  try {
